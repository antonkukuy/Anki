...
class SyntaxHighlighting_Options(QWidget):
    ...
    def switch_center(self):
        center_ = mw.col.conf['syntax_highlighting_conf']['center']
        mw.col.conf['syntax_highlighting_conf']['center'] = not center_
    ...
    def setupUi(self):
        ...
        if mw.col.conf['syntax_highlighting_conf']['center']:
            center_checkbox.setChecked(True)
        center_checkbox.stateChanged.connect(self.switch_center)
