...
HOTKEY = {      # in Reviewer
    'Edit_HTML': '',         # Ctrl+Shift+X
    'Edit_Fields': '',         # e
    'Edit_Cards': '',   #
    'Edit_Fieldz': '',    # Alt+F4 == Close Window
...
FONTS = {
    ...
    'Front Template':   ('Courier New', 20),
    'Styling':          ('Courier New', 20),
    'Back Template':    ('Courier New', 20),

    'HTML Editor':      ('Courier New', 16),

    'Add-ons Edit...':  ('Calibri', 20),
    'showText':         ('Calibri', 16),
...
selection-color: black; background-color: #444; border-style: solid;
